package com.example.musicapp.musicoffline
...
import com.example.musicapp.databinding.ActivityMusicOfflineBinding
...
import com.example.musicapp.musicoffline.view.AboutActivity
...
import com.example.musicapp.musicoffline.view.playingmusic.PlayerActivity
...
import com.example.musicapp.musicoffline.view.setting.SettingActivity
...
class ActivityMusicOffline : AppCompatActivity() {
    private lateinit var binding: ActivityMusicOfflineBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMusicOfflineBinding.inflate(layoutInflater)
        ...
        binding.playNextBtn.setOnClickListener {
            startActivity(Intent(this, PlayNext::class.java))
        }
