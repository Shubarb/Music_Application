package com.example.musicapp.musicoffline.view.playingmusic
...
import com.example.musicapp.databinding.AudioBoosterBinding
import com.example.musicapp.musicoffline.ActivityMusicOffline
import com.example.musicapp.musicoffline.ActivityMusicOffline.Companion.currentTheme
import com.example.musicapp.musicoffline.models.*
import com.example.musicapp.musicoffline.view.favorite.FavouriteActivity
import com.example.musicapp.musicoffline.view.playlist.PlaylistActivity
import com.example.musicapp.musicoffline.view.playlist.PlaylistDetails
import com.example.musicapp.musicoffline.view.playnext.PlayNext
import com.example.musicapp.musicoffline.view.service.MusicService
...
class PlayerActivity : AppCompatActivity(),ServiceConnection, MediaPlayer.OnCompletionListener {
    ...
    private fun initializeLayout(){
        ...
        when(intent.getStringExtra("class")){
            ...
            "MusicAdapterSearch"-> initServiceAndPlaylist(ActivityMusicOffline.musicListSearch, shuffle = false)
            "MusicAdapter" -> initServiceAndPlaylist(ActivityMusicOffline.MusicListMA, shuffle = false)
            "FavouriteAdapter"-> initServiceAndPlaylist(FavouriteActivity.favouriteSongs, shuffle = false)
            "MainActivity"-> initServiceAndPlaylist(ActivityMusicOffline.MusicListMA, shuffle = true)
