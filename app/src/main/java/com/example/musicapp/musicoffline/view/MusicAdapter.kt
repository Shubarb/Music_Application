...
import com.example.musicapp.databinding.DetailsViewBinding
import com.example.musicapp.databinding.MoreFeaturesBinding
...
import com.example.musicapp.musicoffline.models.formatDuration
...
//                        .setBackground(ColorDrawable(0x99000000.toInt()))
        ...
        when{
            ...
            selectionActivity ->{
                ...
                holder.root.setOnClickListener {
                when{
                    ActivityMusicOffline.search -> sendIntent(ref = "MusicAdapterSearch", pos = position)
