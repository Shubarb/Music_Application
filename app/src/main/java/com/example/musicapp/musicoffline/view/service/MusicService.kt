package com.example.musicapp.musicoffline.view.service
...
import com.example.musicapp.musicoffline.models.getImgArt
import com.example.musicapp.musicoffline.receiver.NotificationReceiver
import com.example.musicapp.musicoffline.view.playingmusic.NowPlaying
...
class MusicService : Service(), AudioManager.OnAudioFocusChangeListener  {
    ...
    fun showNotification(playPauseBtn: Int){
        val intent = Intent(baseContext, ActivityMusicOffline::class.java)
